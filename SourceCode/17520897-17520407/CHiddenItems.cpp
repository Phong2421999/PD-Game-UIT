#include "CHiddenItems.h"

void CHiddenItems::Render()
{
	RenderBoundingBox(x, y);
}

void CHiddenItems::Update(DWORD dt, vector<LPGAMEOBJECT> *coObjects)
{
...
bool CHiddenItems::IsTouchSimon(LPGAMEOBJECT gameObject) {
