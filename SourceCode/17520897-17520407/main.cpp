...
{
	HWND hWnd = CreateGameWindow(hInstance, nCmdShow, 320, SCREEN_HEIGHT);
	...
	SetWindowPos(hWnd, 0, 0, 0, 320 * 2, SCREEN_HEIGHT * 2, SWP_NOMOVE | SWP_NOOWNERZORDER | SWP_NOZORDER);
	Run();
